// piscinaTeste modifica algumas funções para verificar resultados
...
void ft_print_combn0(int n){
    ...
    while ( /*(contaCiclos < 500) &&*/ continuar) {   // para evitar ciclos infinitos
...
//    ft_putnbr(-232983982);
    write(1, "\n8 ", 3);
//    ft_print_combn(9);       // falta este
    ft_print_combn0(9);       // teste
    printf("\n");
    write(1, "\nend", 4);
